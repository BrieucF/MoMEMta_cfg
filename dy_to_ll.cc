...
int main(int argc, char** argv) {
    ...
    lua_parameters.set("matrix_element_directory", "pp_to_llbb"); //  pp_to_llbb, gg_to_z_to_llbb,

    ConfigurationReader configuration("dy_to_ll.lua", lua_parameters);
    ...
    std::vector<std::pair<double, double>> weights = weight.computeWeights({p3, p5, p4, p6});

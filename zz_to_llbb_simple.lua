...
if USE_TF then
    ...
    BlockA.blocka = {
        inputs = {bjet1.reco_p4, bjet2.reco_p4, 'tf_neg_lepton::output', 'tf_pos_lepton::output', isr.reco_p4},
    }
    Looper.looper = {
        solutions = "blocka::solutions",
        path = Path("tfEval_bjet1", "tfEval_bjet2", "boost", "zz", "integrand") -- everything that will depend on the different solutions
    }

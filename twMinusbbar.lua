...
BlockB.blockb = {
    inputs = {neg_lepton.gen_p4, }, -- The first output of BlockB will be the anti-neutrino associated to neg_lepton
                     -- (W- > l- nu~), to be propagated in the ME below
                     -- No need to pass him the other particles for the pt tot balance since instead we impose PT neutrino == (MET-firstNeutrino) 

...
-- NB: to be defined in the .cc is matrix_element_directory
...
TFFile = baseDirTF .. "truncLowGen_tf_sep30/condor/output/allTT_smoothed.root"
parameters = {
    energy = 13000.,
    top_mass = 173.,
    top_width = 1.491500,
    ...
    lep1_me_index = 1,
    lep1TFFile = TFFile,
    lep1TFName = "ERecMinEGenVSEGen_el_matchedToAfterFSR_allEta_Norm",
    lep2_me_index = 2,
    lep2TFFile = TFFile,
    lep2TFName = "ERecMinEGenVSEGen_el_matchedToAfterFSR_allEta_Norm",
    jet1TFFile = TFFile,
    jet1TFName = "ERecMinEGenVSEGen_bjet_matchedToAfterFSR_allEta_Norm",
    jet2TFFile = TFFile,
    jet2TFName = "ERecMinEGenVSEGen_bjet_matchedToAfterFSR_allEta_Norm",
    matrix_element = matrix_element_directory .. "_sm_P1_Sigma_sm_gg_epembbx", --"pp_to_Z_to_llbb_sm_P1_Sigma_sm_gg_epembbx", 'pp_to_llbb_sm_P1_Sigma_sm_gg_epembbx', 'gg_to_z_to_llbb_sm_P1_Sigma_sm_gg_epembbx', 'gg_to_z_to_llbb_sm_P1_Sigma_sm_gg_mupmumbbx',
    matrix_element_parameters = baseDirME .. "/" .. matrix_element_directory .. "/Cards/param_card.dat",
}
matrix_element_lib = baseDirME .. "/" .. matrix_element_directory .. "/build/libme_" .. matrix_element_directory .. ".so"
...
if USE_TF then
    ...
    BlockA.blocka = {
        inputs = {'input::particles/3', 'input::particles/4', 'looper_energy_fromZmass::particles/1', 'tf_p2::output'},
    }
    Looper.looper = {
